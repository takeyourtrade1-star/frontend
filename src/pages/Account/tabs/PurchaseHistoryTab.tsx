/**
 * PurchaseHistoryTab Component
 * Tab per visualizzare cronologia acquisti
 */

import { useState, useEffect } from 'react'
import { FileText, Search, Filter, Calendar } from 'lucide-react'
import { fetchPurchaseHistory } from '@/services/accountService'
...
export default function PurchaseHistoryTab() {
  ...
  const loadOrders = async () => {
    try {
      setIsLoading(true)
      const response = await fetchPurchaseHistory(currentPage, itemsPerPage, {
